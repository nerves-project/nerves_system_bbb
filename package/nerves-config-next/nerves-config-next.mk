...
# directory.
NERVES_CONFIG_NEXT_SOURCE =
NERVES_CONFIG_NEXT_VERSION = 0.7

NERVES_CONFIG_NEXT_DEPENDENCIES = erlinit erlang host-fwup-next fwup-next ncurses nerves_heart uboot-tools boardid openssl rng-tools
...
define NERVES_CONFIG_NEXT_INSTALL_TARGET_CMDS
